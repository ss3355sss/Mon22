...
void ENUpdatePopup::Register()
{
	...
	const FString CurrentPluginVersion = "3.13";
...
void ENUpdatePopup::Open()
{
	...
	TSharedRef<SVerticalBox> InnerContent = SNew(SVerticalBox)
		...
		[
			SNew(STextBlock)
			.Font(HeadingFont)
			.Text(FText::FromString("Electronic Nodes v3.13"))
		]
		+ SVerticalBox::Slot()
		  .FillHeight(1.0)
		  .Padding(10)
...
* Add entitlement check disabling (<a id="browser" href="https://github.com/hugoattal/ElectronicNodes/issues/83">issue #83</>)
